...
from sqlalchemy import Column, UUID, String, DateTime, ForeignKey, Enum, Float, UniqueConstraint
...
class Application(TenantBase):
    ...
    __table_args__ =  (UniqueConstraint('job_id', 'user_id', name='job_user_application'), )
