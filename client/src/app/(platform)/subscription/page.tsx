...
export default function SubscriptionPage() {
  ...
  // Automatically redirect to signup page step 3 (payment)
  useEffect(() => {
    if (accountStatus?.toLowerCase() === "subscription") {
      // Redirect to signup with step parameter to show payment page
          ...
          <div className="text-center py-16">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-600 mb-8">
                You need to complete your subscription to access all WorkZone
                features. Continue with the signup process to select your plan.
              </p>
